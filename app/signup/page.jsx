    ...
    <div className="w-full py-16 flex justify-center items-center bg-[#113E21]">
      <div className="flex">
        ...
        <div className="relative bg-[#B38B59] px-44 py-16 rounded-3xl ">
          ...
          <div className="absolute bg-[#113E21] top-[131px] px-5 py-5 -right-5 rounded-full"></div>
          <div className="absolute bg-[#B38B59] top-[171px] px-10 py-5 -right-12 rounded-full"></div>
          <div className="absolute bg-[#B38B59] top-[171px] px-5 py-5 -right-[106px] rounded-full"></div>
          <div className="absolute bg-[#B38B59] bottom-[10%] px-14 py-5 -right-20 rounded-full"></div>
          <div className="absolute bg-[#113E21] bottom-[131px] px-5 py-5 -right-5 rounded-full"></div>
          <div className="absolute bg-[#B38B59] bottom-[171px] px-14 py-5 -right-14 rounded-full"></div>
          ...
          <div className="text-[#252620] font-medium mb-20">
            ...
            <a href="/signin" className="text-[#113E21] hover:underline">
              Connecter vous
            </a>
          </div>
        </div>
